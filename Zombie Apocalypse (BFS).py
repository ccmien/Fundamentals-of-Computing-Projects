...
class Zombie(poc_grid.Grid):
    ...
    def compute_distance_field(self, entity_type):
        ...
        distance_field = [[grid_height * grid_width for _col in range(grid_width)] for _row in range(grid_height)]
    ...
    def move_humans(self, zombie_distance):
        ...
        for (num, human) in enumerate(self._human_list):
            max_pos = human
    ...
    def move_zombies(self, human_distance):
        ...
        are allowed
        """
        for (num, zombie) in enumerate(self._zombie_list):
            min_pos = zombie
            ...
            self._zombie_list[num] = min_pos

# Start up gui for simulation - You will need to write some code above
# before this will work without errors
# poc_zombie_gui.run_gui()
